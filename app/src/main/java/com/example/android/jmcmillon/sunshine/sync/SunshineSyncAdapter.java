package com.example.android.jmcmillon.sunshine.sync;
...
import com.example.android.jmcmillon.sunshine.BuildConfig;
import com.example.android.jmcmillon.sunshine.MainActivity;
import com.example.android.jmcmillon.sunshine.R;
import com.example.android.jmcmillon.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final int WEATHER_NOTIFICATION_ID = 3004; // id is matched to notification in order to reuse it
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // NotificationCompatBuilder is a convenient way to build backward-compatible notifications
